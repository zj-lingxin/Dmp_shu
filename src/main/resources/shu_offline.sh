...
spark_master=spark://hadoop3.asto.com:7077
...
spark-submit  --master=$spark_master --driver-java-options -DPropPath=$PROJECT_HOME/prop.properties  --jars /data/spark/lib/mysql-connector-java-5.1.35.jar  --class  com.asto.dmp.shu.base.Main $PROJECT_HOME/dmp_shu.jar $time_cur  >> $PROJECT_LOG_HOME/offline/$date_cur/spark_shu.log

hdfs dfs -ls /shu/output/offline/$year_month/$day/$time_cur/finalForecast
